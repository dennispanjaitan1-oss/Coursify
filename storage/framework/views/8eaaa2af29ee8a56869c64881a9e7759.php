...
<aside class="sidebar" id="sidebar">
  <a href="<?php echo e(route('home')); ?>" class="sidebar-logo">
    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Coursify" class="sidebar-logo-img">
  ...
  <div class="sidebar-body">
    ...
    <nav>
      <a href="<?php echo e(route('student.index')); ?>"
         class="nav-item <?php echo e(request()->routeIs('student.index') ? 'active' : ''); ?>">
        <i class="fa-solid fa-gauge-high nav-icon"></i>
        <span>Dashboard</span>
      </a>
      <a href="<?php echo e(route('student.courses')); ?>"
         class="nav-item <?php echo e(request()->routeIs('student.courses') ? 'active' : ''); ?>">
        <i class="fa-solid fa-book-open nav-icon"></i>
        <span>My Courses</span>
      </a>
      <a href="<?php echo e(route('courses.index')); ?>"
         class="nav-item <?php echo e(request()->routeIs('courses.*') ? 'active' : ''); ?>">
        <i class="fa-solid fa-compass nav-icon"></i>
        <span>Browse</span>
      </a>
      <a href="<?php echo e(route('student.wishlist')); ?>"
         class="nav-item <?php echo e(request()->routeIs('student.wishlist') ? 'active' : ''); ?>">
        <i class="fa-solid fa-heart nav-icon"></i>
        <span>Wishlist</span>
      </a>
      <a href="<?php echo e(route('student.certificates')); ?>"
         class="nav-item <?php echo e(request()->routeIs('student.certificates') ? 'active' : ''); ?>">
    ...
    <nav>
      <a href="<?php echo e(route('student.profile')); ?>"
         class="nav-item <?php echo e(request()->routeIs('student.profile') ? 'active' : ''); ?>">
  ...
  <div class="sidebar-footer">
    <div class="sidebar-user">
      ...
      <div class="user-meta">
        ...
        <div class="user-role"><?php echo e($user->role); ?></div>
      </div>
      <form method="POST" action="<?php echo e(route('logout')); ?>" style="margin:0;display:flex;">
        <?php echo csrf_field(); ?>
  ...
  <div class="page-content">
      ...
      <div class="hero-content">
        <div class="hero-eyebrow">
          ...
          <span class="hero-eyebrow-text">
            ...
            <?php echo e(now()->hour < 12 ? 'Good morning' : (now()->hour < 17 ? 'Good afternoon' : 'Good evening')); ?>

          </span>
        </div>
        <h1 class="hero-title">
          Welcome back,<br><em><?php echo e(explode(' ', $user->name)[0]); ?></em>
        </h1>
        <p class="hero-sub">
          <?php if($lastEnrollment): ?>
            You're <?php echo e($lastEnrollment->real_progress_percent ?? 0); ?>% through
            <strong style="color:rgba(255,255,255,0.85)"><?php echo e($lastEnrollment->course->title); ?></strong>.
            Keep going!
          <?php else: ?>
        ...
        <div class="hero-btns">
          <a href="<?php echo e($lastEnrollment ? route('student.learn', $lastEnrollment->course->slug) : route('courses.index')); ?>"
             class="btn btn-white">
            <i class="fa-solid fa-play" style="font-size:10px;"></i>
            <?php echo e($lastEnrollment ? 'Continue Learning' : 'Browse Courses'); ?>

          </a>
          <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-ghost">
    ...
    <div class="stats-strip">
      <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e($stats['enrolled']); ?></div>
      ...
      <div class="stat-card">
        ...
        <div class="stat-value">
          <?php echo e($stats['study_hours']); ?><small>h</small>
        </div>
        <div class="stat-trend <?php echo e(($weekTrend ?? 0) >= 0 ? 'trend-up' : ''); ?>">
          <?php if($weekTrend !== null): ?>
            <i class="fa-solid fa-arrow-<?php echo e($weekTrend >= 0 ? 'up' : 'down'); ?>" style="font-size:9px;"></i>
            <?php echo e(abs($weekTrend)); ?>% vs last week
          <?php else: ?>
            <i class="fa-solid fa-minus" style="font-size:9px;"></i>
            Total tracked
          <?php endif; ?>
      ...
      <div class="stat-card">
        ...
        <div class="stat-value"><?php echo e($stats['certificates']); ?></div>
        <div class="stat-trend trend-neutral">
    ...
    <div>
      <div class="sec-head">
        ...
        <a href="<?php echo e(route('student.courses')); ?>" class="sec-link">All courses →</a>
      </div>
      ...
      <?php if($lastEnrollment): ?>
        ...
        <div class="continue-card">
          <div class="continue-thumb">
            ...
            ?>
            <?php if($contThumb): ?>
              <img src="<?php echo e($contThumb); ?>" alt="<?php echo e($lastEnrollment->course->title); ?>"
          ...
          <div>
            <div class="continue-tag <?php echo e($isDone ? 'done' : ''); ?>">
              <span class="continue-dot"></span>
              <?php echo e($isDone ? 'Completed' : 'In Progress'); ?>

            </div>
            <div class="continue-title"><?php echo e($lastEnrollment->course->title); ?></div>
            <div class="continue-sub">
              <?php echo e($lastEnrollment->real_completed_lessons ?? 0); ?> of
              <?php echo e($lastEnrollment->real_total_lessons ?? 0); ?> lessons
              <?php if(!$isDone): ?> · <?php echo e(max(($lastEnrollment->real_total_lessons ?? 0) - ($lastEnrollment->real_completed_lessons ?? 0), 0)); ?> remaining <?php endif; ?>
            </div>
            <div class="progress-track">
              <div class="progress-fill <?php echo e($isDone ? 'complete' : ''); ?>"
                   style="width: <?php echo e($prog); ?>%"></div>
            </div>
            <div class="progress-label"><?php echo e($prog); ?>% complete</div>
          </div>

          <?php
             $canViewCert = $isDone && in_array($lastEnrollment->type, ['verified', 'honor']);
          ?>
          <a href="<?php echo e($canViewCert
      ...
      <?php else: ?>
        <div class="continue-card">
          <div class="empty-continue">
            ...
            <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-accent">
              <i class="fa-solid fa-compass" style="font-size:11px;"></i>
              Browse Courses
            </a>
          </div>
    ...
    <?php if($myCourses->count() > 0): ?>
    <div>
      <div class="sec-head">
        <h2 class="sec-title">My <em>courses</em></h2>
        <a href="<?php echo e(route('student.courses')); ?>" class="sec-link">View all →</a>
      </div>
      <div class="courses-grid">
        <?php $__currentLoopData = $myCourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e(route('student.learn', $item->slug)); ?>" class="course-card">
            <div class="course-card__thumb">
              ...
              ?>
              <?php if($thumbSrc): ?>
                <img src="<?php echo e($thumbSrc); ?>" alt="<?php echo e($item->course->title); ?>">
              <?php else: ?>
            ...
            <div class="course-body" style="padding:14px 16px 16px;">
              <div class="course-cat" style="font-size:10px;font-weight:700;letter-spacing:0.09em;text-transform:uppercase;color:var(--accent);margin:0 0 6px;"><?php echo e(optional($item->course->category)->name ?? 'Course'); ?></div>
              <div class="course-title" style="font-size:15px;font-weight:700;line-height:1.4;margin:0 0 6px;color:var(--text-1);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;"><?php echo e($item->course->title); ?></div>
              <div class="course-instructor" style="font-size:12px;color:var(--text-3);margin:0 0 10px;padding-bottom:10px;border-bottom:1px solid var(--border);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                <?php echo e(optional($item->course->instructors->first())->name ?? 'Instructor'); ?>

              </div>
              <div class="course-progress">
                <div class="course-prog-header">
                  <span><?php echo e($item->progress); ?>%</span>
                  <span><?php echo e($item->completed_count); ?>/<?php echo e($item->total_lessons); ?></span>
                </div>
                <div class="progress-track">
                  <div class="progress-fill <?php echo e($item->status === 'completed' ? 'complete' : ''); ?>"
    ...
    <div class="two-col">
      ...
      <div class="panel">
        ...
        <div class="activity-kpi">
          <div>
            <div class="kpi-big"><?php echo e($weekTotalHours); ?><span>h</span></div>
            <div class="kpi-label">Total this week</div>
          </div>
          <?php if($weekTrend !== null): ?>
            <div class="stat-trend <?php echo e($weekTrend >= 0 ? 'trend-up' : ''); ?>" style="margin-bottom:8px;">
              <i class="fa-solid fa-arrow-<?php echo e($weekTrend >= 0 ? 'up' : 'down'); ?>" style="font-size:9px;"></i>
              <?php echo e(abs($weekTrend)); ?>% vs last week
            </div>
          <?php endif; ?>
        ...
        <div class="bar-chart">
          <?php $__currentLoopData = $weekActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bar-col <?php echo e($day['is_today'] ? 'today' : ''); ?> <?php echo e($day['seconds'] == 0 ? 'zero' : ''); ?>">
              <?php if($day['seconds'] > 0): ?>
                <div class="bar-tip"><?php echo e($day['label']); ?></div>
              <?php endif; ?>
              <div class="bar-track">
                <?php if($day['seconds'] > 0): ?>
                  <div class="bar-fill" style="height: <?php echo e($day['percentage']); ?>%;"></div>
                <?php endif; ?>
              </div>
              <div class="bar-label"><?php echo e($day['day']); ?></div>
            </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div class="activity-legend">
          <?php if(($weekBreakdown['video'] ?? 0) > 0): ?>
            <div class="legend-item">
              <span class="legend-dot" style="background: var(--accent);"></span>
              Video · <?php echo e($weekBreakdown['video']); ?>h
            </div>
          <?php endif; ?>
          <?php if(($weekBreakdown['exercise'] ?? 0) > 0): ?>
            <div class="legend-item">
              <span class="legend-dot" style="background: var(--green);"></span>
              Exercise · <?php echo e($weekBreakdown['exercise']); ?>h
            </div>
          <?php endif; ?>
          <?php if(($weekBreakdown['reading'] ?? 0) > 0): ?>
            <div class="legend-item">
              <span class="legend-dot" style="background: var(--amber);"></span>
              Reading · <?php echo e($weekBreakdown['reading']); ?>h
            </div>
          <?php endif; ?>
          <?php if(($weekBreakdown['video'] ?? 0) + ($weekBreakdown['exercise'] ?? 0) + ($weekBreakdown['reading'] ?? 0) == 0): ?>
      ...
      <div class="panel">
        <div class="panel-head">
          ...
          <a href="<?php echo e(route('student.courses')); ?>" class="sec-link">Schedule →</a>
        </div>

        <?php if($upNext->count() > 0): ?>
          <div class="upcoming-list">
            <?php $__currentLoopData = $upNext->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e(route('student.learn', $item['course_slug'])); ?>"
                 class="upcoming-item">
                <div class="upcoming-time-block">
                  <div class="up-day">Next</div>
                  <div class="up-clock"><?php echo e($item['duration']); ?></div>
                </div>
                <div class="up-icon icon-<?php echo e($item['lesson_type'] ?? 'video'); ?>">
                  <?php if($item['lesson_type'] === 'quiz'): ?>
                    <i class="fa-solid fa-clipboard-question"></i>
                  <?php elseif($item['lesson_type'] === 'project'): ?>
                    <i class="fa-solid fa-code"></i>
                  <?php elseif($item['lesson_type'] === 'reading'): ?>
                ...
                <div class="up-info">
                  <div class="up-title"><?php echo e($item['lesson_title']); ?></div>
                  <div class="up-meta"><?php echo e($item['course_title']); ?></div>
                </div>
              </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
    ...
    <div>
      <div class="sec-head">
        ...
        <a href="<?php echo e(route('student.certificates')); ?>" class="sec-link">All badges →</a>
      </div>
      ...
      <div class="ach-grid">
        <?php $__empty_1 = true; $__currentLoopData = $achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="ach-card">
            <div class="ach-icon <?php echo e($colorMap[$ach['color']] ?? 'ai-indigo'); ?>">
              <i class="<?php echo e($ach['icon']); ?>"></i>
            </div>
            <div class="ach-title"><?php echo e($ach['title']); ?></div>
            <div class="ach-desc"><?php echo e($ach['description']); ?></div>
            <div class="ach-date"><?php echo e($ach['date_label']); ?></div>
          </div>
    ...
    <?php if($recommended->count() > 0): ?>
    <div>
      <div class="sec-head">
        <h2 class="sec-title">Recommended <em>for you</em></h2>
        <a href="<?php echo e(route('courses.index')); ?>" class="sec-link">Browse all →</a>
      </div>
      <div class="rec-grid">
...
</html><?php /**PATH C:\laragon\www\coursify\resources\views/student/index.blade.php ENDPATH**/ ?>