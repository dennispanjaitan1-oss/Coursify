...
<?php $__env->startSection('title', $institution->name . ' — Coursify'); ?>
...
<div class="detail-back">
    <a href="<?php echo e(route('universities')); ?>" class="back-link">
    ...
    <div class="detail-hero-inner">
        ...
        <div class="detail-logo-wrap">
            <?php if(!empty($institution->logo_url)): ?>
                <img src="<?php echo e($institution->logo_url); ?>" alt="<?php echo e($institution->name); ?>"
                     onerror="this.style.display='none';this.nextElementSibling.style.display='block';">
                <span class="detail-logo-initials" style="display:none;">
                    <?php echo e(strtoupper(substr($institution->name, 0, 2))); ?>
        ...
        <div class="detail-hero-info">
            <div class="detail-badge">
                ...
                <?php if($institution->is_verified): ?> Verified Partner <?php else: ?> Institusi <?php endif; ?>
            </div>
            <h1 class="detail-title"><?php echo e($institution->name); ?></h1>
            <?php if(!empty($institution->website_url)): ?>
            <a href="<?php echo e($institution->website_url); ?>" target="_blank" class="detail-website">
                <i class="fa-solid fa-globe"></i>
                <?php echo e(parse_url($institution->website_url, PHP_URL_HOST) ?? $institution->website_url); ?>
            ...
            <div class="detail-hero-stats">
                <div class="detail-hero-stat">
                    <div class="detail-hero-stat-val"><?php echo e($institution->courses_count ?? 0); ?></div>
                ...
                <div class="detail-hero-stat">
                    <div class="detail-hero-stat-val">
                        <?php echo e($institution->avg_rating ? number_format($institution->avg_rating, 1) : '—'); ?>
        ...
        <div class="detail-section">
            ...
            <p class="detail-desc">
                <?php if(!empty($institution->description)): ?>
                    <?php echo e($institution->description); ?>

                <?php else: ?>
                    <?php echo e($fakerDesc); ?>
        ...
        <div class="detail-section">
            <div class="detail-section-title">
                ...
                <span style="float:right;font-weight:400;color:#4A4660;text-transform:none;letter-spacing:0;">
                    <?php echo e($institution->courses_count ?? 0); ?> kursus total
                </span>
            </div>

            <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('courses.show', $course->slug)); ?>" class="course-row">
                <div class="course-icon">
                    <i class="fa-solid fa-book-open"></i>
                </div>
                <div class="course-row-info">
                    <div class="course-row-title"><?php echo e($course->title); ?></div>
                    <div class="course-row-meta">
                        <?php echo e($course->category->name ?? 'Umum'); ?>

                        &nbsp;·&nbsp;
                        <?php echo e(number_format($course->enrollments_count)); ?> pelajar
                    </div>
                </div>
                <?php if($course->price == 0): ?>
                    <span class="course-row-badge">Gratis</span>
                <?php else: ?>
                    <span class="course-row-badge"><span class="course-row-badge"><?php echo e($course->formatted_price); ?></span>
                <?php endif; ?>
            </a>
            ...
            <?php if(($institution->courses_count ?? 0) > 6): ?>
            <a href="<?php echo e(route('courses.index', ['institution' => $institution->slug])); ?>"
               style="display:block;text-align:center;margin-top:16px;color:#5B4FD4;font-size:13px;font-weight:600;text-decoration:none;">
                Lihat semua <?php echo e($institution->courses_count); ?> kursus
    ...
    <div>
        <div class="sidebar-card">
            ...
            <div class="info-row">
                ...
                <span class="info-row-val">
                    <?php if($institution->is_verified): ?>
            ...
            <div class="info-row">
                ...
                <span class="info-row-val"><?php echo e($institution->courses_count ?? 0); ?></span>
            </div>
            <div class="info-row">
                <span class="info-row-label">Total Pelajar</span>
                <span class="info-row-val">
                    <?php $s = $institution->students_count ?? 0; echo $s < 1000 ? $s : (floor($s/1000).'K+'); ?>
                </span>
            </div>
            <div class="info-row">
            ...
            <?php if(!empty($institution->website_url)): ?>
            <a href="<?php echo e($institution->website_url); ?>" target="_blank" class="cta-btn">
                <i class="fa-solid fa-arrow-up-right-from-square"></i>
                &nbsp;Kunjungi Website
            </a>
            <?php endif; ?>

            <a href="<?php echo e(route('courses.index', ['institution' => $institution->slug])); ?>" class="cta-btn"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\coursify\resources\views/pages/university-detail.blade.php ENDPATH**/ ?>