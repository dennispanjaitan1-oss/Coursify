...
<section class="page-header">
    ...
    Lanjutkan perjalanan belajarmu dengan mudah! Di halaman ini, kamu bisa melihat semua kursus yang sedang kamu ikuti agar progres belajarmu tetap terpantau.
        ...
        <div class="stats-bar">
            <div class="stat-cell">
                <div class="stat-value"><em><?php echo e($stats['total']); ?></em></div>
                <div class="stat-label">Total Courses</div>
            </div>
            <div class="stat-cell">
                <div class="stat-value"><em><?php echo e($stats['in_progress']); ?></em></div>
                <div class="stat-label">In Progress</div>
            </div>
            <div class="stat-cell">
                <div class="stat-value"><em><?php echo e($stats['completed']); ?></em></div>
                <div class="stat-label">Completed</div>
            </div>
            <div class="stat-cell">
                <div class="stat-value"><em><?php echo e($stats['not_started']); ?></em></div>
...
<section class="main-section">
    ...
    <a href="<?php echo e(route('student.courses')); ?>"
       class="filter-tab <?php echo e($currentFilter === 'all' ? 'active' : ''); ?>">
        All
    </a>

    
    <a href="<?php echo e(route('student.courses', ['filter' => 'in_progress'])); ?>"
       class="filter-tab <?php echo e($currentFilter === 'in_progress' ? 'active' : ''); ?>">
        In Progress
    </a>

    
    <a href="<?php echo e(route('student.courses', ['filter' => 'completed'])); ?>"
       class="filter-tab <?php echo e($currentFilter === 'completed' ? 'active' : ''); ?>">
        Completed
    </a>

    
    <a href="<?php echo e(route('student.courses', ['filter' => 'not_started'])); ?>"
       class="filter-tab <?php echo e($currentFilter === 'not_started' ? 'active' : ''); ?>">
        Not Started
    </a>
</div>

           <form action="<?php echo e(route('student.courses')); ?>" method="GET" class="search-mycourses">
    ...
    $btnClass = '';
                ...
                <div class="course-card">
                    <div class="course-card__thumb">
                        ...
                        <?php elseif($enrollment->type === 'verified'): ?>
                        ...
                        <?php elseif($enrollment->type === 'honor'): ?>
                        ...
                        <?php endif; ?>
                        <?php if($thumbnailUrl): ?>
                            <img src="<?php echo e($thumbnailUrl); ?>" alt="<?php echo e($courseTitle); ?>">
                        <?php else: ?>
                    ...
                    <div class="course-card__body" style="padding:14px 16px 16px; flex:1; display:flex; flex-direction:column;">
                        ...
                        <div class="course-progress-section">
                            <div class="progress-header">
                                ...
                                <span class="progress-percent"><?php echo e(number_format($progress, 0)); ?>%</span>
                            </div>
                            <div class="progress-bar">
                                <div class="progress-fill <?php echo e($progressClass); ?>" style="width: <?php echo e($progress); ?>%;"></div>
                            </div>
                            <div class="course-lesson-info">
                                <?php echo e($lessonsDone); ?> of <?php echo e($lessonsTotal); ?> lessons completed
                            </div>
                        </div>
...
<a href="<?php echo e(($progress >= 100 || $status === 'completed') && in_array($enrollment->type, ['verified', 'honor']) 
    ? route('student.certificates') 
    : route('student.learn', ['slug' => $courseSlug])); ?>"
   class="btn-continue <?php echo e($btnClass); ?>">
    <?php echo $btnLabel; ?>
...
<?php if($enrollment->type === 'audit' && $course->hasCertificatePrice() && $course->isUpgradeAvailable()): ?>
<a href="<?php echo e(route('payment.index', ['course' => $course->id, 'track' => 'verified', 'upgrade' => 1])); ?>" class="btn-continue" style="background:var(--lav-2); color:var(--purple-dark); padding: 8px 16px;">
    Upgrade
</a>
<?php endif; ?>
...
<button class="course-menu" title="More options"
    ...
    data-course-title="<?php echo e($courseTitle); ?>"
    data-course-slug="<?php echo e($courseSlug); ?>"
    data-course-url="<?php echo e(url('courses/' . $courseSlug)); ?>">
    ⋯
</button>
                        ...
                        <?php if($progress >= 100 || $status === 'completed'): ?>
                            <?php
        ...
        <i class="fa-solid fa-xmark"></i>
                            ...
                            <?php else: ?>
                                <div style="margin-top:12px;" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" x-transition style="margin-top:10px; padding:14px; background:var(--lav-1); border-radius:12px;">
                                        <form action="<?php echo e(route('student.course.review.submit', $course)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('courses.index')); ?>" class="btn-browse">
                        🔍 Browse Courses
                    </a>
                </div>
            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\coursify\resources\views/student/courses.blade.php ENDPATH**/ ?>