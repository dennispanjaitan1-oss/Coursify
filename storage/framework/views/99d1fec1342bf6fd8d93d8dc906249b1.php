...
<title><?php echo e($course->title ?? 'Course'); ?> — Coursify</title>
    ...
    <div class="navbar">
        ...
        <div class="nav-search-wrap" x-data="navSearch()">
            <form class="nav-search-form"
                  action="<?php echo e(route('courses.index')); ?>" method="GET"
                  @submit="open = false"
                  autocomplete="off"
                  role="search"
            ...
            <div class="nav-search-dropdown"
                ...
                <template x-if="!loading && results.length > 0">
                    <div>
                        ...
                        <a :href="`<?php echo e(route('courses.index')); ?>?search=${encodeURIComponent(query)}`"
        ...
        <div class="nav-right">
            ...
            <a href="<?php echo e(route('courses.index')); ?>" class="nav-link-sm active">
                Kursus
            </a>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="nav-link-sm">Masuk</a>
                <a href="<?php echo e(route('login')); ?>" class="btn-cta-nav">
                    Mulai Gratis
                </a>
            <?php else: ?>
                <div style="position:relative;flex-shrink:0;" x-data="{ userOpen: false }">
                    ...
                    <div x-show="userOpen"
                        ...
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-chart-pie"></i> Dashboard</a>
                            <a href="<?php echo e(route('admin.courses.index')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-book-open"></i> Manage Courses</a>
                            <a href="#" class="dropdown-item" role="menuitem"><i class="fa-solid fa-users-gear"></i> Manage Users</a>
                        <?php endif; ?>
                        <?php if(auth()->user()->role === 'instructor'): ?>
                            <a href="<?php echo e(route('instructor.dashboard')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
                        ...
                        <?php if(auth()->user()->role === 'student'): ?>
                            <a href="<?php echo e(route('student.index')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-gauge-high"></i> My Dashboard</a>
                            <a href="<?php echo e(route('student.courses')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-book-open"></i> My Courses</a>
                            <a href="<?php echo e(route('student.wishlist')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-heart"></i> Wishlist</a>
                            <a href="<?php echo e(route('student.certificates')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-award"></i> Certificates</a>
                            <a href="<?php echo e(route('student.profile')); ?>" class="dropdown-item" role="menuitem"><i class="fa-solid fa-user-pen"></i> Profile Settings</a>
                        <?php endif; ?>
            ...
            <div class="mega-grid">
                ...
                <div class="mega-col">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php $__currentLoopData = [['ai','Kecerdasan Buatan'],['web','Web Development'],['data','Data Science'],['cyber','Cybersecurity'],['design','Desain UI/UX'],['mobile','Mobile Dev'],['business','Bisnis & Manajemen']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$slug,$name]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('courses.index')); ?>?category=<?php echo e($slug); ?>" class="mega-link"><?php echo e($name); ?></a>
                ...
                <div class="mega-col">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php $__currentLoopData = ['Sertifikat Profesional','MicroMasters','Program Diploma','Executive Education']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('courses.index')); ?>?type=certificate" class="mega-link"><?php echo e($c); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <a href="<?php echo e(route('courses.index')); ?>?type=certificate" class="mega-link mega-link-cta">Lihat semua →</a>
                </div>
                ...
                <div class="mega-col">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php $__currentLoopData = ['S1 Online','S2 Online','MBA Online','Program Diploma']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('courses.index')); ?>?type=program" class="mega-link"><?php echo e($d); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    <a href="<?php echo e(route('courses.index')); ?>?type=program" class="mega-link mega-link-cta">Lihat semua →</a>
                </div>
                ...
                <div class="mega-col">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php $__currentLoopData = ['Harvard University','Stanford University','MIT','Oxford University','Tsinghua University']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('universities')); ?>" class="mega-link"><?php echo e($u); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
...
<div class="container">
    ...
    <div class="breadcrumb">
        ...
        <span class="breadcrumb-separator">/</span>
        <span class="breadcrumb-current"><?php echo e($course->title ?? 'Course'); ?></span>
    </div>
        ...
        <div class="hero-left">
            <div class="course-badges">
                <?php if($course->category): ?>
                    <span class="hero-badge badge-category"><?php echo e($course->category->name); ?></span>
                <?php endif; ?>
                <?php if($course->difficulty): ?>
                    <span class="hero-badge badge-level"><?php echo e(ucfirst($course->difficulty)); ?></span>
                <?php endif; ?>
            </div>
            ...
            <p class="course-tagline">
                <?php echo e($course->short_description ?? Str::limit($course->description, 200)); ?>
            ...
            <div class="course-stats">
                <div class="stat-item-sm">
                    <div class="stat-item-sm-val">
                        <i class="fa-solid fa-star" style="color:#f59e0b;font-size:11px;"></i> <?php echo e($avgRating ? number_format($avgRating, 1) : '—'); ?>

                    </div>
                    <div class="stat-item-sm-label">(<?php echo e($reviewCount); ?> reviews)</div>
                </div>
                <div class="stat-item-sm">
                    <div class="stat-item-sm-val"><i class="fa-solid fa-users"></i> <?php echo e($course->enrollments_count ?? 0); ?></div>
                    <div class="stat-item-sm-label">Students</div>
                </div>
                <div class="stat-item-sm">
                    <div class="stat-item-sm-val"><i class="fa-solid fa-book-open"></i> <?php echo e($totalLessons); ?></div>
                    <div class="stat-item-sm-label">Lessons</div>
                </div>
                <?php if($course->language): ?>
                    <div class="stat-item-sm">
                        <div class="stat-item-sm-val"><i class="fa-solid fa-globe"></i> <?php echo e(strtoupper($course->language)); ?></div>
            ...
            <?php if($instructor): ?>
                <div class="instructor-chip">
                    <div class="instructor-avatar-lg" style="<?php echo e($instructor->photo_url ?? false ? 'padding:0;overflow:hidden;' : ''); ?>">
                        <?php if($instructor->photo_url ?? false): ?>
                            <img src="<?php echo e($instructor->photo_url); ?>"
                                 alt="<?php echo e($instructor->name); ?>"
                                 style="width:100%;height:100%;object-fit:cover;border-radius:50%;display:block;"
                                 onerror="this.style.display='none';this.parentElement.innerHTML='<?php echo e(strtoupper(substr($instructor->name, 0, 1))); ?>';">
                        <?php else: ?>
                    ...
                    <div class="instructor-info-sm">
                        ...
                        <span class="instructor-name-sm"><?php echo e($instructor->name); ?></span>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <div class="course-meta-grid">
                <div class="course-meta-item">
                    ...
                    <div>
                        <div class="course-meta-val"><?php echo e($course->duration_weeks); ?> <?php echo e($course->duration_weeks > 1 ? 'weeks' : 'week'); ?></div>
                        <?php if($course->hours_per_week): ?>
                            <div class="course-meta-sub"><?php echo e($course->hours_per_week); ?> hours per week</div>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="course-meta-item">
                    <?php if($course->start_date): ?>
                        ...
                        <div>
                            <div class="course-meta-val">Starts <?php echo e(\Carbon\Carbon::parse($course->start_date)->format('M j, Y')); ?></div>
                            <?php if($course->enroll_deadline): ?>
                                <div class="course-meta-sub">Enroll by <?php echo e(\Carbon\Carbon::parse($course->enroll_deadline)->format('M j, Y')); ?></div>
                            <?php endif; ?>
                        </div>
                    <?php else: ?>
                        <i class="fa-regular fa-calendar course-meta-icon"></i>
            ...
            <div class="course-details-grid">
                <div class="course-detail-item">
                    ...
                    <div class="course-detail-value"><?php echo e($course->language ?? 'English'); ?></div>
                </div>
                <div class="course-detail-item">
                    <div class="course-detail-label">
                        <i class="fa-solid fa-globe"></i> Translations
                    </div>
                    <div class="course-detail-value"><?php echo e($course->translations ?? 'None'); ?></div>
                </div>
                <div class="course-detail-item">
                    <div class="course-detail-label">
                        <i class="fa-regular fa-closed-captioning"></i> Transcripts
                    </div>
                    <div class="course-detail-value"><?php echo e($course->transcripts ?? 'English'); ?></div>
                </div>
                <div class="course-detail-item">
                    <div class="course-detail-label">
                        <i class="fa-solid fa-clipboard-check"></i> Prerequisites
                    </div>
                    <div class="course-detail-value"><?php echo e($course->prerequisites ?? 'None'); ?></div>
                </div>
            </div>
        </div>
                ...
                <div class="enroll-body">
                    <?php if($isEnrolled): ?>
                        <div style="text-align:center; margin-bottom: 20px;">
                            ...
                            <a href="<?php echo e(route('student.learn', $course->slug)); ?>" class="btn-enroll" style="text-decoration:none;">
                    ...
                    <?php else: ?>
                        <div class="price-block">
                            <div class="price-main">
                                <?php if($course->isFree() && !$course->hasCertificatePrice()): ?>
                                    <span class="price-now">GRATIS</span>
                                <?php elseif($course->hasCertificatePrice()): ?>
                                    <span class="price-now">Audit gratis</span>
                                <?php else: ?>
                                    <span class="price-now"><?php echo e($course->formatted_price); ?></span>
                                <?php endif; ?>
                            </div>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('courses.choose-path', $course)); ?>" class="btn-enroll" style="text-decoration:none;">
                                <i class="fa-solid fa-route"></i> Enroll Now
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="btn-enroll" style="text-decoration:none;">
                                Login to Enroll
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
...
<button class="btn-wishlist <?php echo e($isWishlisted ? 'active' : ''); ?>"
    onclick="toggleWishlistBtn(this, <?php echo e($course->id); ?>)"
    aria-label="<?php echo e($isWishlisted ? 'Hapus dari wishlist' : 'Simpan ke wishlist'); ?>">
    <i class="<?php echo e($isWishlisted ? 'fa-solid' : 'fa-regular'); ?> fa-heart" style="margin-right:6px;"></i>
    <?php echo e($isWishlisted ? 'Tersimpan di Wishlist' : 'Simpan ke Wishlist'); ?>
                    ...
                    <ul class="includes-list">
                        <li class="includes-item">
                            ...
                            <span><strong><?php echo e($totalLessons); ?></strong> lessons</span>
                        </li>
                        <li class="includes-item">
    ...
    <section class="content-section">
        ...
        <?php if($course->syllabus->isNotEmpty()): ?>
            <div class="learn-grid">
                <?php $__currentLoopData = $course->syllabus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="learn-item">
                        <div class="learn-check"><i class="fa-solid fa-check"></i></div>
                        <div class="learn-text"><?php echo e($item->item); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php else: ?>
    ...
    <section class="content-section">
        <div class="curriculum-header">
            <div>
                ...
                <p class="section-desc">
                    <?php echo e($course->sections->count()); ?> sections ·
        ...
        <div class="curriculum-stats">
            <div class="curr-stat">
                <span class="curr-stat-num"><?php echo e($course->sections->count()); ?></span>
                <span class="curr-stat-label">Sections</span>
            </div>
            <div class="curr-stat">
                <span class="curr-stat-num"><?php echo e($totalLessons); ?></span>
                <span class="curr-stat-label">Lessons</span>
            </div>
            <div class="curr-stat">
                <span class="curr-stat-num"><?php echo e($reviewCount); ?></span>
                <span class="curr-stat-label">Reviews</span>
            </div>
            <div class="curr-stat">
                <span class="curr-stat-num"><?php echo e($course->enrollments_count ?? 0); ?></span>
                <span class="curr-stat-label">Students</span>
            </div>
            <div class="curr-stat">
                <span class="curr-stat-num"><?php echo e($avgRating ? number_format($avgRating,1) : '—'); ?></span>
        ...
        <div class="curriculum-list">
            <?php $__currentLoopData = $course->sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="curriculum-section <?php echo e($index === 0 ? 'expanded' : ''); ?>">
                    <button class="section-header-btn" onclick="toggleSection(this)" type="button">
                        <div class="section-header-left">
                            <div class="section-icon">+</div>
                            <div class="section-text">
                                <div class="section-number">Section <?php echo e($index + 1); ?></div>
                                <div class="section-name"><?php echo e($section->title); ?></div>
                            </div>
                        </div>
                        <div class="section-header-right">
                            <span class="section-meta-item"><i class="fa-solid fa-book-open"></i> <?php echo e($section->lessons->count()); ?> lessons</span>
                        </div>
                    </button>
...
<section class="content-section">
    <h2 class="section-title">Meet your <em><?php echo e($instructors->count() > 1 ? 'instructors' : 'instructor'); ?></em></h2>
    <p class="section-desc"><?php echo e($instructors->count() > 1 ? 'Learn from industry experts' : 'Learn from an industry expert'); ?></p>
    ...
    <div class="instructor-profile">
        <div class="instructor-header">
            <div class="instructor-avatar-xl" style="<?php echo e($inst->photo_url ? 'padding:0;overflow:hidden;' : ''); ?>">
                <?php if($inst->photo_url): ?>
                    <img src="<?php echo e($inst->photo_url); ?>"
                         alt="Photo of <?php echo e($inst->name); ?>"
                         style="width:100%;height:100%;object-fit:cover;border-radius:50%;display:block;"
                         onerror="this.style.display='none';this.parentElement.innerHTML='<?php echo e(strtoupper(substr($inst->name, 0, 1))); ?>';">
                <?php else: ?>
                    <?php echo e(strtoupper(substr($inst->name, 0, 1))); ?>

                <?php endif; ?>
            </div>
            <div class="instructor-main-info">
                <h3 class="instructor-full-name"><?php echo e($inst->name); ?></h3>
                <?php $instTitle = $inst->title ?? ($inst->headline ?? null); ?>
                <?php if($instTitle): ?>
                    <div class="instructor-profession"><?php echo e($instTitle); ?></div>
                <?php endif; ?>
            </div>
            <?php if($inst->institution_logo_url ?? false): ?>
                <div class="instructor-university-card">
                    <div class="instructor-university-icon">
                        <img src="<?php echo e($inst->institution_logo_url); ?>"
        ...
        <?php if($inst->bio ?? false): ?>
            <div class="instructor-bio"><p><?php echo e($inst->bio); ?></p></div>
        <?php endif; ?>
    </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</section>
<?php endif; ?>
    ...
    <section class="content-section">
        ...
        <div class="reviews-summary">
            <div class="review-overall">
                <div class="overall-rating">
                    <span class="rating-value">
                        <em><?php echo e($avgRating ? number_format($avgRating, 1) : '—'); ?></em>
                    </span>
                    ...
                    <div class="rating-total">Based on <?php echo e($reviewCount); ?> reviews</div>
                </div>
            </div>
            <div class="rating-distribution">
                ...
                ?>
                <?php $__currentLoopData = $distribution; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $pct = $reviewCount > 0 ? round($row['count'] / $reviewCount * 100) : 0; ?>
                    <div class="dist-row">
                        <span class="dist-label"><?php echo e($row['stars']); ?> <i class="fa-solid fa-star"></i></span>
                        <div class="dist-bar">
                            <div class="dist-fill" style="width: <?php echo e($pct); ?>%;"></div>
                        </div>
                        <span class="dist-percent"><?php echo e($pct); ?>%</span>
                        <span class="dist-count">(<?php echo e($row['count']); ?>)</span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="reviews-list">
            <?php $__empty_1 = true; $__currentLoopData = $course->reviews->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="review-header">
                        ...
                        <div class="review-meta">
                            <div class="review-stars">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <span class="star <?php echo e($i <= $review->rating ? 'filled' : ''); ?>"><i class="fa-solid fa-star"></i></span>
                                <?php endfor; ?>
                            </div>
    ...
    <section class="cta-banner">
        ...
        <div class="cta-content">
            ...
            <h2 class="cta-title">
                Ready to start learning <em><?php echo e($course->title); ?></em>?
            </h2>
            <p class="cta-subtitle">
                Join <?php echo e($course->enrollments_count ?? 0); ?>+ students already enrolled.
            </p>
            ...
            <div class="cta-price">
                ...
                <?php else: ?>
                    <span class="cta-price-now"><?php echo e($course->formatted_price); ?></span>
                <?php endif; ?>
            </div>
            ...
            <div class="cta-buttons">
                ...
                <?php elseif(auth()->check()): ?>
                    <a href="<?php echo e(route('courses.choose-path', $course)); ?>"
                       class="btn-cta-primary" style="text-decoration:none;">
                        <i class="fa-solid fa-route"></i> Enroll Now <i class="fa-solid fa-arrow-right"></i>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-cta-primary" style="text-decoration:none;">
            ...
            <div class="cta-trust">
                ...
                <div class="cta-trust-item"><span class="cta-trust-icon"><i class="fa-solid fa-trophy"></i></span><span><?php echo e($course->hasCertificatePrice() ? 'Verified certificate available' : 'Free course access'); ?></span></div>
            </div>
        </div>
    </section>
    ...
    <footer class="course-footer">
        <div class="footer-content">
            ...
            <div class="footer-copy">© <?php echo e(date('Y')); ?> Coursify · Supporting SDG 4 <i class="fa-solid fa-globe"></i></div>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\coursify\resources\views/courses/show.blade.php ENDPATH**/ ?>