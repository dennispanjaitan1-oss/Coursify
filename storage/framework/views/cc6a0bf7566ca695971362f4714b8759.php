...
unset($__errorArgs, $__bag); ?>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>"
            ...
            <div class="role-section">
                ...
                <div class="role-grid">
                    <label class="role-card <?php echo e(old('role','student')==='student' ? 'selected' : ''); ?>" id="role-student">
                    ...
                    <label class="role-card <?php echo e(old('role')==='instructor' ? 'selected' : ''); ?>" id="role-instructor">
                        <input type="radio" name="role" value="instructor"
                            <?php echo e(old('role')==='instructor' ? 'checked' : ''); ?>
            ...
            <div class="field">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name')); ?>"
                        ...
                        class="<?php echo e($errors->has('name') ? 'error-input' : ''); ?>">
                </div>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="footer-note">
        © <?php echo e(date('Y')); ?> <strong>Coursify</strong> Platform E-Learning
    </div>
</div>
...
<div class="right">
    ...
    <a href="<?php echo e(route('home')); ?>" class="home-link">
...
</html><?php /**PATH C:\laragon\www\coursify\resources\views/auth/register.blade.php ENDPATH**/ ?>