<?php $__env->startSection('title', 'Coursify - Learn Anything, Anytime'); ?>
            ...
            <div class="promo-slide-content">
                <div class="promo-slide-left">
                    ...
                    <div class="promo-slide-actions">
                        <a href="<?php echo e(route('courses.index')); ?>" class="promo-btn-primary">Lihat Kursus →</a>
                        <a href="<?php echo e(route('courses.index')); ?>" class="promo-btn-outline">Jelajahi Kursus</a>
                    </div>
                </div>
                <div class="promo-slide-right">
                    <?php
                        ...
                        $c2 = $displayCourses[1];
                    ?>
                    <a href="<?php echo e($c1['slug']); ?>" class="hero-course-card" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c1['thumbnail_url'])): ?>
                                <img src="<?php echo e($c1['thumbnail_url']); ?>" alt="<?php echo e($c1['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c1['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c1['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c1['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c1['title']); ?></h4>
                            <?php if(!empty($c1['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c1['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c1['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c1['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c1['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c1['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>

                    <a href="<?php echo e($c2['slug']); ?>" class="hero-course-card promo-card-offset" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c2['thumbnail_url'])): ?>
                                <img src="<?php echo e($c2['thumbnail_url']); ?>" alt="<?php echo e($c2['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c2['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c2['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c2['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c2['title']); ?></h4>
                            <?php if(!empty($c2['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c2['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c2['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c2['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c2['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c2['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
        ...
        <div class="promo-slide">
            ...
            <div class="promo-slide-content">
                <div class="promo-slide-left">
                    ...
                    <div class="promo-slide-actions">
                        <a href="<?php echo e(route('register')); ?>" class="promo-btn-primary">Mulai Gratis →</a>
                ...
                <div class="promo-slide-right">
                    <?php
                        ...
                        $c4 = $displayCourses[3];
                    ?>
                    <a href="<?php echo e($c3['slug']); ?>" class="hero-course-card" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c3['thumbnail_url'])): ?>
                                <img src="<?php echo e($c3['thumbnail_url']); ?>" alt="<?php echo e($c3['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c3['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c3['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c3['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c3['title']); ?></h4>
                            <?php if(!empty($c3['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c3['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c3['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c3['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c3['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c3['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>

                    <a href="<?php echo e($c4['slug']); ?>" class="hero-course-card promo-card-offset" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c4['thumbnail_url'])): ?>
                                <img src="<?php echo e($c4['thumbnail_url']); ?>" alt="<?php echo e($c4['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c4['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c4['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c4['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c4['title']); ?></h4>
                            <?php if(!empty($c4['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c4['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c4['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c4['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c4['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c4['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
        ...
        <div class="promo-slide">
            ...
            <div class="promo-slide-content">
                <div class="promo-slide-left">
                    ...
                    <div class="promo-slide-actions">
                        <a href="<?php echo e(route('courses.index')); ?>" class="promo-btn-primary">Mulai Belajar →</a>
                        <a href="<?php echo e(route('courses.index')); ?>" class="promo-btn-outline">Jelajahi Kursus</a>
                    </div>
                </div>
                <div class="promo-slide-right">
                    <?php
                        ...
                        $c6 = $displayCourses[5];
                    ?>
                    <a href="<?php echo e($c5['slug']); ?>" class="hero-course-card" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c5['thumbnail_url'])): ?>
                                <img src="<?php echo e($c5['thumbnail_url']); ?>" alt="<?php echo e($c5['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c5['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c5['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c5['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c5['title']); ?></h4>
                            <?php if(!empty($c5['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c5['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c5['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c5['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c5['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c5['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>

                    <a href="<?php echo e($c6['slug']); ?>" class="hero-course-card promo-card-offset" style="text-decoration:none;">
                        <div class="hero-card__thumb">
                            <?php if(!empty($c6['thumbnail_url'])): ?>
                                <img src="<?php echo e($c6['thumbnail_url']); ?>" alt="<?php echo e($c6['title']); ?>" style="width:100%;height:100%;object-fit:cover;display:block;">
                            <?php else: ?>
                                <div style="width:100%;height:100%;background:linear-gradient(135deg,#6366f1,#8b5cf6);display:flex;align-items:center;justify-content:center;">
                                    <span style="font-size:28px;color:rgba(255,255,255,0.5);"><?php echo e($c6['icon'] ?? '🎓'); ?></span>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="hero-card__body">
                            <?php if(!empty($c6['category'])): ?>
                                <p class="hero-card__category"><?php echo e(strtoupper($c6['category'])); ?></p>
                            <?php endif; ?>
                            <h4 class="hero-card__title"><?php echo e($c6['title']); ?></h4>
                            <?php if(!empty($c6['instructor'])): ?>
                                <p class="hero-card__instructor"><?php echo e($c6['instructor']); ?></p>
                            <?php endif; ?>
                            <div class="hero-card__meta">
                                <?php if(!empty($c6['rating'])): ?>
                                    <span><i class="fa-solid fa-star" style="color:#f59e0b;"></i> <?php echo e($c6['rating']); ?></span>
                                <?php endif; ?>
                                <?php if(!empty($c6['duration'])): ?>
                                    <span><i class="fa-regular fa-clock"></i> <?php echo e($c6['duration']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </a>
    ...
    <div class="hero-container">
        <div class="hero-content">
            ...
            <div class="hero-cta" style="margin-left: 0; margin-right: 0; max-width: 100%; align-items: flex-start;">
                <form action="<?php echo e(route('courses.index')); ?>" method="GET" class="hero-selector-form" style="margin-left: 0;">
                        ...
                        <div class="selector-group">
                            ...
                            <select name="category[]" id="subject-select" class="selector-dropdown">
                                ...
                                <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($subject->slug); ?>"><?php echo e($subject->name); ?></option>
                    ...
                    <div class="phone-screen">
                        ...
                        <div class="phone-card">
                            <div class="phone-avatar" style="border-radius:12px; overflow:hidden;">
                                <img src="<?php echo e(asset('images/landing.png')); ?>" alt="Andi" 
...
<section class="stats">
    <div class="container">
        <div class="stats-bar">
            <div class="stat-item">
                <div class="stat-value"><em><?php echo e($stats['students'] ?? '50K+'); ?></em></div>
                <div class="stat-label">Active Learners</div>
            </div>
            <div class="stat-item">
                <div class="stat-value"><em><?php echo e($stats['courses'] ?? '500+'); ?></em></div>
                <div class="stat-label">Courses</div>
            </div>
            <div class="stat-item">
                <div class="stat-value"><em><?php echo e($stats['instructors'] ?? '120+'); ?></em></div>
                <div class="stat-label">Expert Instructors</div>
            </div>
            <div class="stat-item">
                <div class="stat-value"><em><?php echo e($stats['satisfaction'] ?? '98%'); ?></em></div>
    ...
    <div class="container">
        ...
        <div class="trust-marquee-wrapper">
            <div class="trust-marquee">
                <?php $doubled = array_merge($partnerInstitutions, $partnerInstitutions); ?>
                <?php $__currentLoopData = $doubled; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(route('universities.show', $partner['slug'])); ?>"
                       ...
                       title="<?php echo e($partner['name']); ?>">
                        ...
                        <span class="trust-partner-fallback" style="display:none;">
                            <?php echo e(\Illuminate\Support\Str::limit($partner['name'], 20)); ?>
    ...
    <div class="container">
        ...
        <div class="latest-slider-wrapper">
            ...
            <div class="latest-slider" id="latestSlider">
                ...
                <a href="<?php echo e(route('courses.show', $course['slug'])); ?>" class="latest-card">
                    <div class="latest-card-header">
                        <span>Course</span>
                        
                    </div>
                    <div class="latest-card-thumb">
                        <img src="<?php echo e($course['thumbnail_url'] ?: 'https://placehold.co/600x400/153759/FFFFFF?text=Course'); ?>" alt="<?php echo e($course['title']); ?>">
                        <div class="latest-card-logo">
                            <?php if($course['institution_logo']): ?>
                                <img src="<?php echo e($course['institution_logo']); ?>" alt="Logo">
                            <?php else: ?>
                                <span style="font-weight:bold;font-size:11px;color:#333;"><?php echo e(\Illuminate\Support\Str::limit($course['institution'], 10)); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="latest-card-body">
                        <h3 class="latest-card-title"><?php echo e($course['title']); ?></h3>
                        <p class="latest-card-inst"><?php echo e($course['institution']); ?></p>
                        
                        <div class="latest-card-meta">
                            <div><i class="fa-regular fa-clock"></i> <?php echo e($course['duration']); ?></div>
                            <div><i class="fa-solid fa-signal"></i> <?php echo e($course['level']); ?></div>
                        </div>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="latest-dots" id="latestDots">
            <?php $pages = ceil(count($latestCourses) / 3); ?>
            <?php for($i = 0; $i < $pages; $i++): ?>
                <button class="latest-dot <?php echo e($i === 0 ? 'active' : ''); ?>" onclick="scrollToLatestPage(<?php echo e($i); ?>)" aria-label="Go to page <?php echo e($i+1); ?>"></button>
            <?php endfor; ?>
        </div>

        <div style="text-align: center; margin-top: 40px;">
            <a href="<?php echo e(route('courses.index', ['sort' => 'newest'])); ?>" class="latest-btn-browse">Browse additional courses</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="courses-grid">
            ...
            <?php $__currentLoopData = $coursesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(isset($course['slug']) ? route('courses.show', $course['slug']) : route('courses.index')); ?>" 
                   class="course-card" 
                    ...
                    <div class="course-card__thumb" style="position:relative; aspect-ratio:16/9; overflow:hidden; border-radius:12px 12px 0 0; background:#1a1a2e;">
                        ...
                        <?php else: ?>
                            <div style="width:100%;height:100%;background:linear-gradient(135deg,#1e3a5f,#2d4d7a);display:flex;align-items:center;justify-content:center;">
                                <?php echo $course['icon'] ?? '<i class="fa-solid fa-graduation-cap" style="font-size:40px;color:rgba(255,255,255,0.3);"></i>'; ?>
        ...
        <div style="text-align:center;margin-top:32px;">
            <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-light">View All Courses </a>
        </div>
    </div>
</section>
...
?>
            ...
            <?php $__currentLoopData = $instructorsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="instructor-card">
                   <div class="instructor-avatar" style="overflow:hidden;padding:0;">
    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($inst['name'])); ?>&background=1E3A5F&color=fff&size=150&bold=true"
         style="width:100%;height:100%;object-fit:cover;">
</div>
                    <div class="instructor-name"><?php echo e($inst['name']); ?></div>
                    <div class="instructor-title"><?php echo e($inst['title']); ?></div>
                    <div class="instructor-tags">
                        <?php $__currentLoopData = $inst['tags']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="instructor-tag"><?php echo e($tag); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="instructor-stats">
    <span><i class="fa-solid fa-book"></i> <?php echo e($inst['courses']); ?> courses</span>
    <span><i class="fa-solid fa-users"></i> <?php echo e($inst['students']); ?> students</span>
</div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="container">
        ...
        <div class="category-grid">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('courses.index', ['category' => $category['slug']])); ?>" class="category-card">
                    <div class="category-icon"><?php echo $category['icon']; ?></div>
                    <div class="category-name"><?php echo e($category['name']); ?></div>
                    <div class="category-count"><?php echo e($category['count']); ?> course<?php echo e($category['count'] !== 1 ? 's' : ''); ?></div>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>

        <div style="text-align: center; margin-top: 32px;">
            <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-light">Browse all topics</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="faq-wrapper" x-data="{ openFaq: null }">
            ...
            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="faq-item" :class="{ 'active': openFaq === <?php echo e($index); ?> }">
                    <button class="faq-question" @click="openFaq = openFaq === <?php echo e($index); ?> ? null : <?php echo e($index); ?>">
                        <span><?php echo e($faq['q']); ?></span>
                        <span class="faq-icon">+</span>
                    </button>
                    <div class="faq-answer">
                        <div class="faq-answer-inner"><?php echo e($faq['a']); ?></div>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <div class="container">
        ...
        <div class="hero-cta">
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-dark">Start Learning Free</a>
                <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-light">▶ Browse Courses</a>
            <?php else: ?>
                <a href="<?php echo e(route('courses.index')); ?>" class="btn btn-dark">Explore Courses →</a>
            <?php endif; ?>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\coursify\resources\views/home/index.blade.php ENDPATH**/ ?>