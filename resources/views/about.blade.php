...
<section class="about-hero">
    <div class="container">
        ...
        <div class="about-hero-actions">
            <a href="{{ route('courses.index') }}" class="btn-about-primary">
            ...
            <div class="glass-card story-timeline">
                ...
                @foreach($milestones as $m)
                    <div class="timeline-item">
                        <div class="timeline-year-badge {{ $m['badge'] }}">
                            {{ substr($m['year'], 2) }}
                        </div>
                        <div class="timeline-content">
                            <div class="timeline-year-label">{{ $m['year'] }}</div>
                            <div class="timeline-event-title">{{ $m['title'] }}</div>
                            <div class="timeline-event-desc">{{ $m['desc'] }}</div>
                        </div>
                    </div>
                @endforeach
            </div>
        ...
        <div class="values-grid">
            ...
            @foreach($values as $v)
                <div class="glass-card value-card">
                    <div class="value-icon-wrap {{ $v['icon_class'] }}">
...
<section class="team-section" id="team">
    ...
    @foreach($team as $member)
        <div class="glass-card team-card">
            <div class="team-avatar {{ $member['color'] }}">
        ...
        <div class="impact-wrapper">
            <div class="impact-content">
                ...
                <div class="sdg-cards">
                    ...
                    @foreach($sdgs as $sdg)
                        <div class="sdg-card">
                            <div class="sdg-number-badge">{{ $sdg['number'] }}</div>
                            <div class="sdg-code">{{ $sdg['code'] }}</div>
                            ...
                            <div class="sdg-progress">
                                ...
                                <div class="sdg-progress-bar">
                                    <div class="sdg-progress-fill" style="width: {{ $sdg['progress'] }}%;"></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="recog-left">
                ...
                @foreach($awards as $award)
                    <div class="glass-card award-item">
                        <div class="award-icon {{ $award['icon_class'] }}">
                            {{ $award['icon'] }}
                        </div>
                        <div>
        ...
        <div class="glass-card join-banner">
            <div class="join-content">
                ...
                <div class="join-cards">
                    ...
                    <a href="{{ route('universities') }}" class="join-card">
                        <div class="join-card-icon">🤝</div>
