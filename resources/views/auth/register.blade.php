...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .sdg-badge-4{ color: var(--purple-dark); }
        .sdg-badge-8{ color: #059669; }
        .sdg-badge-10{ color: #D97706; }
...
<div class="left">
    ...
    <div class="form-wrap">
        ...
        {{-- Benefits --}}
        <div class="benefits">
            @foreach(['Ratusan kursus gratis','Progress tersimpan','Sertifikat digital','Komunitas aktif'] as $b)
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{ showPassword: false, showConfirm: false }">
            ...
            <div class="role-section">
                ...
                <div class="role-grid">
                    <label class="role-card {{ old('role','student')==='student' ? 'selected' : '' }}">
                        <input type="radio" name="role" value="student" {{ old('role','student')==='student' ? 'checked' : '' }} onchange="selectRole(this)">
                    ...
                    <label class="role-card {{ old('role')==='instructor' ? 'selected' : '' }}">
                        <input type="radio" name="role" value="instructor" {{ old('role')==='instructor' ? 'checked' : '' }} onchange="selectRole(this)">
                        <div class="role-icon">👨‍🏫</div>
                        <div>
            ...
            {{-- SDG --}}
            <div class="sdg-line">
                Dengan mendaftar, kamu mendukung <strong>SDG 4 — Pendidikan Berkualitas</strong> 🌍
            </div>
        </form>
    </div>

    <div class="footer-note">
        © {{ date('Y') }} <strong>Coursify</strong> · Platform E-Learning Indonesia
    </div>
</div>
...
<div class="right">
    ...
    <div class="right-content">
        ...
        <div class="sdg-wrapper">
            ...
            <div class="sdg-strip">
                <span class="sdg-badge sdg-badge-4">📚 SDG 4 · Pendidikan</span>
                <span class="sdg-badge sdg-badge-8">💼 SDG 8 · Pekerjaan</span>
                <span class="sdg-badge sdg-badge-10">⚖️ SDG 10 · Kesetaraan</span>
            </div>
        </div>
    </div>
</div>
...
// Password strength checker — style Calmia
function checkStrength(val) {
    ...
    const configs = [
        { w: '0%',   c: '#8B87A8', t: 'Masukkan password' },
        { w: '25%',  c: '#FF8A5B', t: 'Lemah' },
        { w: '50%',  c: '#FFC452', t: 'Cukup' },
        { w: '75%',  c: '#7B6FE8', t: 'Kuat' },
        { w: '100%', c: '#00C896', t: 'Sangat kuat ✓' },
    ];
