        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div>
                ...
                <p class="text-gray-500 mt-1">
                    Kelola semua course pada platform. Kursus dibuat oleh Instructor masing-masing.
                </p>
            </div>

            <div class="flex items-center gap-3">
                <span class="text-xs text-gray-400 bg-gray-100 px-3 py-2 rounded-xl">
                    <i class="fa-solid fa-circle-info mr-1"></i>
                    Admin hanya mengelola & memoderasi kursus
                </span>
            </div>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        class="bg-indigo-50 hover:bg-indigo-100 text-indigo-600 text-sm font-semibold px-4 py-2 rounded-xl transition flex items-center gap-1 shadow-sm"
                                    >
                                        <i class="fa-solid fa-hammer text-[11px]"></i>
                                        <span>Builder</span>
                                    </a>
...
{{-- Create Modal dihapus — Admin tidak membuat kursus. Gunakan Instructor panel. --}}
{{-- ================================================= --}}
...
// createModal removed — admins do not create courses
